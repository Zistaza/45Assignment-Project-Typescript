...
while (myguestlist.length > 2) {
    ...
    console.log("I am really sorry, ".concat(guestremoved, " I cant invite you to iftaar dinner"));
}
//still invitation function
console.log("Invitation to my two remaining guests");
myguestlist.forEach(function (remainingtwo) { return console.log("hey guys ".concat(remainingtwo, ", you both are still invited to iftr dinner")); });
